...
%
% last updated: 1/28/15 3:33pm
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [c_zf, S_zf, IN_zf, SINR_zf, c_mrt, S_mrt, IN_mrt, SINR_mrt, Uj_rho, actBSv, archv, n] = SINR_het_rho_nearbyBS(NCmax, NCmin, distUB, nM, nP, L0, alpha_m, alpha_p, M, Uj, P, rho, N_nearBS, c_zf_BS)
...
%             cluster_indextp  	=   zeros(1, nB);
%             cluster_indextp (N_nearBS+1-BS_index(yb)) =   1;
%             str_cluster_index   =   num2str(cluster_indextp );
%             str_cluster_index(isspace(str_cluster_index))   =   '';
%             cluster_index       =   bin2dec(str_cluster_index);
